...
public final class MariaDBClanAllyStorage extends AbstractSQLClanAllyStorage {
        ...
        try (
            ...
            try {
                for (final ClanAllyEntry entry : entries) {
                    ps.setObject(1, entry.clanUniqueId());
                    ps.setObject(2, entry.allyClanUniqueId());
    ...
    public void deleteBatch(final @NotNull Collection<ClanAllyEntry> entries) {
        ...
        try (
            ...
            try {
                for (final ClanAllyEntry entry : entries) {
                    preparedStatement.setObject(1, entry.clanUniqueId());
                    preparedStatement.setObject(2, entry.allyClanUniqueId());
    ...
    public @NotNull Async async() {
        return new Async() {
            ...
            private @NotNull MariaDBClanAllyStorage instance() {
                return MariaDBClanAllyStorage.this;
            }
