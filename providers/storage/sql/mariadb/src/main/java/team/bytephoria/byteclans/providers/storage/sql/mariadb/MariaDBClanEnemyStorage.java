...
public final class MariaDBClanEnemyStorage extends AbstractSQLClanEnemyStorage {
    ...
    public MariaDBClanEnemyStorage(
    ...
    public Collection<ClanEnemyView> findByClanUniqueId(final @NotNull UUID clanUniqueId) {
        try (
            ...
            preparedStatement.setObject(1, clanUniqueId);
    ...
    public void create(final @NotNull ClanEnemyEntry entry) {
        try (
            ...
            preparedStatement.setObject(2, entry.enemyClanUniqueId());
    ...
    public void delete(final @NotNull UUID clanUniqueId, final @NotNull UUID enemyClanUniqueId) {
        try (
            ...
            preparedStatement.setObject(1, clanUniqueId);
            preparedStatement.setObject(2, enemyClanUniqueId);
            preparedStatement.executeUpdate();
        } catch (final SQLException exception) {
            this.logger().log(Level.WARNING, exception.getMessage(), exception);
        }
    ...
    public @NotNull Async async() {
        return new Async() {
            ...
            private @NotNull MariaDBClanEnemyStorage instance() {
                return MariaDBClanEnemyStorage.this;
            }
