...
public final class MariaDBStorageConnection extends AbstractSQLStorageConnection {

    public MariaDBStorageConnection(final @NotNull HikariDataSource dataSource) {
        super(dataSource);
    }
